...
function MaintenanceRecord() {
  ...
  // Data is hidden when page first loads
  ...
  // PAGINATION
  // -------------------------------------------------------
  const recordsToShow = hasSearched
    ? filteredRecords
    : [];
